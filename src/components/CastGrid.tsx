...
// Hero of the story — first card gets a red treatment.
const ACCENT_NAME = "عزيز";
        ...
        <div className="flex items-end justify-between gap-8 mb-14 md:mb-20">
          <div>
            ...
            <h2 className="text-4xl md:text-6xl font-black leading-[1.15] tracking-tight">
              سبع شخصيات.
              <br />
              <span className="text-bone/45">إيقاع واحد لا يُنسى.</span>
            </h2>
          </div>
          <p className="hidden md:block text-bone/55 max-w-xs leading-relaxed">
            عزيز هو القلب — والشلة حواليه، كل واحد فيهم بيلعب جزء من الكوميديا.
          </p>
        </div>
