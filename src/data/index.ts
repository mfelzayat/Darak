...
export const tagline =
  "هد كده هد كده هتشتري آي مارينا ريزيدنس .. فمتلخص العمر يفوت.";

export const taglineEn =
  "Take it easy — but at Marina I Residence, life shouldn't slip past you.";

export const concept =
  "شلة من العواجيز يطلاع عينهم في الساحل بعد ما عزيز يستلم شاليهه في مارينا آي ريزيدنس. ينطلق عزيز ليستمتع بكل وسائل الرفاهية متصابياً وسط الشباب و الـ Gen Z، بينما العواجيز يحاولون اللحاق به متعجبين من نشاطه المفرط، ولا يكفّون عن المقارنة بين المكان وشاليهاتهم في الساحل القديم — في إطار كوميدي.";

export const characters: Character[] = [
  { name: "عزيز", age: 60, role: "البطل — متصابي بطاقة شباب الـ Gen Z" },
  { name: "سمير", age: 60, role: "صديقه — ساخر، عصبي النضج" },
  { name: "شبل", age: 60, role: "صديقه — هادئ، أب لطفلين" },
  { name: "أم عزيز", age: 85, role: "بتخاف عليه كأنه صغير، بتقول رأيها في كل حاجة" },
  { name: "ماريام", age: 60, role: "ممرضة فلبينية — لباس محتشم، تضحك على كل شيء" },
  { name: "نور", age: 28, role: "فائقة الجمال — مخطوبة لطارق سراً" },
  { name: "سليم", age: 22, role: "صديق عزيز الشاب الوحيد" },
];
...
export const scenes: Scene[] = [
  {
    ...
    shots: [
      ...
      },
      {
        page: 2,
        note: "Intro to crew",
        description: "تعريف الشلة: عزيز، سمير، شبل، أم عزيز، ماريام في السيارة.",
        dialogue: null,
      },
      {
        page: 3,
  ...
  },
  {
    ...
    shots: [
      ...
      },
      {
        ...
        description:
          "بيلمان مارينا آي ريزيدنس بـ Uniform يساعدونه و ينزلون الشنط من السيارة.",
        dialogue: null,
      },
    ],
  },
  {
    ...
    shots: [
      ...
      },
      {
        ...
        description:
          "يستدير و يدخل الشاليه، يجد ماريام تضع مرهماً على رجل سمير. الجميع منهك.",
        dialogue: [
    ...
    shots: [
      ...
      },
      {
        ...
        dialogue: [
          ...
          {
            by: "أم عزيز",
            line: "شكرا للتأمل اللي ربطته خي وأنا ده الحياة كلها بـ مارينا آي ريزيدنس.",
          },
        ],
      },
      {
